...
export class Agent {
    ...
    async handleMessage(source, message, max_responses=null) {
        ...
        if (!!this.subgoal.item) {
            this.current_subgoal_item = this.subgoal.item;
            this.current_subgoal_amount = this.subgoal.amount || 1;
        ...
        for (let i=0; i<max_responses; i++) {
            ...
            if (this.current_subgoal_item && this.current_subgoal_amount > 0) {
                ...
                if (currentCount >= this.current_subgoal_amount) {
                    ...
                    this.current_subgoal_item = null;
                    this.current_subgoal_amount = 0;
                    this.subgoal = {}; // clear subgoal

                    // Auto-trigger completeSubgoal action
                    this.bot.emit('subgoal_completed');
